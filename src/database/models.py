...
class AuditRun(Base):
    ...
    remediations = relationship("RemediationExecution", back_populates="audit_run", cascade="all, delete-orphan")
...
class AuditFinding(Base):
    ...
    def __repr__(self):
        return f"<AuditFinding(id={self.id}, check_id='{self.check_id}', severity='{self.severity}')>"
