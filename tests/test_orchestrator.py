...
class TestLogger:
    ...
    def test_logger_writes_to_file(self, tmp_path):
        ...
        logger = setup_logger(name="file_test", level="DEBUG", log_file=str(log_file))
    ...
    def test_logger_includes_timestamps(self, tmp_path):
        ...
        logger = setup_logger(name="timestamp_test", log_file=str(log_file))
...
class TestAuditOrchestrator:
    ...
    def config(self):
        ...
        return AuditConfig(require_admin=False, parallel_execution=True, timeout_seconds=60)
