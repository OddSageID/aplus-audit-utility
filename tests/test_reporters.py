...
class TestHTMLReporter:
    ...
    def test_report_handles_empty_findings(self, reporter, tmp_path):
        ...
        data = {
            ...
            "timestamp": datetime.utcnow().isoformat(),
            "platform": "Linux",
            "collectors": {"hardware": {"status": "success", "data": {}, "findings": []}},
        }
...
class TestAIAnalyzer:
    ...
    def sample_audit_results(self):
        ...
        return {
            ...
            "metadata": {"platform": "Windows", "hostname": "DESKTOP-TEST"},
        }
    ...
    def test_analyze_with_no_findings(self, mock_anthropic, analyzer):
        ...
        audit_data = {"collectors": {"hardware": {"findings": []}, "security": {"findings": []}}}
...
class TestJSONReporter:
    ...
    def test_json_export(self, tmp_path):
        ...
        data = {
            ...
            "findings": [{"check_id": "TST-001", "severity": "LOW"}],
        }
...
class TestReporterErrorHandling:
    ...
    def test_ai_analyzer_handles_invalid_api_key(self):
        ...
        config = AIConfig(provider="anthropic", api_key="invalid_key_xyz", max_tokens=1000)
